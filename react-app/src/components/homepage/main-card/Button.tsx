export const Button = ({ isInfoButton }: { isInfoButton: boolean }) => {
  if (!isInfoButton) {
    return (
      <button className="bg-[#A67144] text-[#3e2a19] min-w-52 justify-center hover:gap-3 hover:brightness-90 transition-all hover:shadow-xl rounded-full px-8 py-2 flex gap-2 place-items-center shadow-md">
