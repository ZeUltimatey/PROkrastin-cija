export const Button = ({ isInfoButton }: { isInfoButton: boolean }) => {
  if (!isInfoButton) {
    return (
      <button className="bg-accent-brown text-dark-brown min-w-64 justify-center hover:gap-4 hover:brightness-90 text-lg transition-all hover:shadow-xl rounded-full px-8 py-3.5 flex gap-2 place-items-center shadow-md">
